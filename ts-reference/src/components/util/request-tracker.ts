...
class RequestTracker {
  ...
  oldestActiveRequest(): RequestDescriptor {
    /**
  ...
  async progressDialogCheck() {
    ...
    if (oldestActiveRequest.age && oldestActiveRequest.age >= 250 && !this.isShowingProgress) {
      this.show();
    } else if (oldestActiveRequest.age && oldestActiveRequest.age >= 250 && this.isShowingProgress) {
