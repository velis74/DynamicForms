...
class Action {
  ...
  constructor(data: any, parent?: any) {
    ...
    function displayStyleBreakpointClean(bp: any) {
      if (!_.isObjectLike(bp)) return null;
      const cbp = displayStyleProps.reduce((res: any, p) => {
    ...
    function conditionalAddBreakpoint(ds: any, breakpoint: any) {
    ...
    function decorateHandlerWithPayload(hwp: any) {
