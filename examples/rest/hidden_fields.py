...
class HiddenFieldsSerializer(serializers.ModelSerializer):
    ...
    int_fld = fields.AutoGeneratedField(conditional_visibility=F("unit").is_in(lambda: ("pcs", "cst")))
    qty_fld = fields.AutoGeneratedField(conditional_visibility=F("unit") == "wt")
    cst_fld = fields.AutoGeneratedField(conditional_visibility=F("unit") == "cst")
