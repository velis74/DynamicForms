            ...
            if isinstance(s_field, (fields.ChoiceMixin, fields.RelatedFieldAJAXMixin)) or (
                ...
                if s_field:
                    if isinstance(s_field, fields.AutoGeneratedField):
                        display_table = s_field.get("display_table", DisplayMode.SUPPRESS)
                    else:
                        display_table = getattr(s_field, "display_table", DisplayMode.SUPPRESS)
                if (display_table == DisplayMode.SUPPRESS) or (
                ...
                if s_field:
                    if isinstance(s_field, fields.AutoGeneratedField):
                        render_params = s_field.get("render_params")
                    else:
                        render_params = getattr(s_field, "render_params", None)
